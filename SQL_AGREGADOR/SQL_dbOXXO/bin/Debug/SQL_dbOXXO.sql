/*
Deployment script for SQL_dbOXXO
...
GO
:setvar DatabaseName "SQL_dbOXXO"
:setvar DefaultFilePrefix "SQL_dbOXXO"
:setvar DefaultDataPath "C:\Users\Ivan\AppData\Local\Microsoft\VisualStudio\SSDT\SQL_dbOXXO"
:setvar DefaultLogPath "C:\Users\Ivan\AppData\Local\Microsoft\VisualStudio\SSDT\SQL_dbOXXO"
...
GO
ALTER TABLE [agr].[REFERENCIA] WITH NOCHECK
...
GO
ALTER TABLE [agr].[PROCESSERROR] WITH NOCHECK
...
GO
ALTER TABLE [agr].[PROCESSCONTROL] WITH NOCHECK
...
GO
ALTER TABLE [agr].[CONFVALIDACIONES] WITH NOCHECK
...
GO
ALTER TABLE [agr].[CONFIG_NIVEL_ESTABLECIMIENTO] WITH NOCHECK
...
GO
ALTER TABLE [agr].[CONFIG_COL_ESTABLECIMIENTO] WITH NOCHECK
...
GO
ALTER TABLE [agr].[CONFIG_CLIENTE] WITH NOCHECK
...
GO
ALTER TABLE [agr].[REFERENCIA] WITH CHECK CHECK CONSTRAINT [FK_chrIdMoneda_REF];

ALTER TABLE [agr].[REFERENCIA] WITH CHECK CHECK CONSTRAINT [FK_intIdProcessControl_REF];

ALTER TABLE [agr].[REFERENCIA] WITH CHECK CHECK CONSTRAINT [FK_sntIdCliente_REF];

ALTER TABLE [agr].[REFERENCIA] WITH CHECK CHECK CONSTRAINT [FK_sntIdEstablecimiento_REF];

ALTER TABLE [agr].[REFERENCIA] WITH CHECK CHECK CONSTRAINT [FK_tnyIdEstatus_REF];

ALTER TABLE [agr].[PROCESSERROR] WITH CHECK CHECK CONSTRAINT [FK_intIdProcessControl_PRE];

ALTER TABLE [agr].[PROCESSERROR] WITH CHECK CHECK CONSTRAINT [FK_numIdValidacion_PRE];

ALTER TABLE [agr].[PROCESSCONTROL] WITH CHECK CHECK CONSTRAINT [FK_tnyIdOrigen_PRO];

ALTER TABLE [agr].[CONFVALIDACIONES] WITH CHECK CHECK CONSTRAINT [FK_numIdValidacion_CVA];

ALTER TABLE [agr].[CONFVALIDACIONES] WITH CHECK CHECK CONSTRAINT [FK_sntIdCliente_CVA];

ALTER TABLE [agr].[CONFVALIDACIONES] WITH CHECK CHECK CONSTRAINT [FK_tnyIdNivel_CVA];

ALTER TABLE [agr].[CONFIG_NIVEL_ESTABLECIMIENTO] WITH CHECK CHECK CONSTRAINT [FK_sntIdEstablecimiento_CNE];

ALTER TABLE [agr].[CONFIG_COL_ESTABLECIMIENTO] WITH CHECK CHECK CONSTRAINT [FK_intIdConNivEstable_CCE];

ALTER TABLE [agr].[CONFIG_COL_ESTABLECIMIENTO] WITH CHECK CHECK CONSTRAINT [FK_sntIdEstablecimiento_CCE];

ALTER TABLE [agr].[CONFIG_CLIENTE] WITH CHECK CHECK CONSTRAINT [FK_sntIdCliente_COC];

ALTER TABLE [agr].[CONFIG_CLIENTE] WITH CHECK CHECK CONSTRAINT [FK_sntIdConfiguracion_COC];
