...
GO
/*
The column bitIsActivo on table [agr].[CLIENTE] must be changed from NULL to NOT NULL. If the table contains data, the ALTER script may not work. To avoid this issue, you must add values to this column for all rows or mark it as allowing NULL values, or enable the generation of smart-defaults as a deployment option.
*/
...
GO
PRINT N'Rename refactoring operation with key 6586b9ef-65ed-43ef-bfb4-48cf9c88490a is skipped, element [agr].[CLIENTE].[PruebaCambio] (SqlSimpleColumn) will not be renamed to PruebaCambioNuevo';


GO
PRINT N'Dropping [agr].[CLIENTE].[IX_NC_varGUIDCliente_X1]...';


GO
DROP INDEX [IX_NC_varGUIDCliente_X1]
    ON [agr].[CLIENTE];


GO
PRINT N'Dropping [agr].[DF_bitIsActivo_CLI]...';


GO
ALTER TABLE [agr].[CLIENTE] DROP CONSTRAINT [DF_bitIsActivo_CLI];
...
GO
ALTER TABLE [agr].[CLIENTE] ALTER COLUMN [bitIsActivo] BIT NOT NULL;


GO
ALTER TABLE [agr].[CLIENTE]
    ADD [PruebaCambioNuevo] VARCHAR (10) NULL;
